...
export const COMMAND_META = {
  ...
  'attack -t badmsg':   { severity: SEVERITY.CRITICAL, category: 'attack',   target: 'wifi',     resultHint: 'Bad EAPOL attack', destructive: true },
  'attack -t sleep':    { severity: SEVERITY.HIGH,     category: 'attack',   target: 'wifi',     resultHint: 'Sleep attack', destructive: true },
  'attack -t quiet':    { severity: SEVERITY.HIGH,     category: 'attack',   target: 'wifi',     resultHint: 'Quiet attack', destructive: true },
  'attack -t sae':      { severity: SEVERITY.HIGH,     category: 'attack',   target: 'wifi',     resultHint: 'SAE commit flood', destructive: true },
  'attack -t csa':      { severity: SEVERITY.HIGH,     category: 'attack',   target: 'wifi',     resultHint: 'CSA broadcast', destructive: true },
  ...
  'blespam -t all':     { severity: SEVERITY.HIGH,     category: 'attack',   target: 'ble',      resultHint: 'BLE spam all', destructive: true },
  'blespam -t sourapple':{ severity: SEVERITY.HIGH,    category: 'attack',   target: 'ble',      resultHint: 'Sour Apple', destructive: true },
  'blespam -t applejuice':{ severity: SEVERITY.HIGH,   category: 'attack',   target: 'ble',      resultHint: 'Apple Juice', destructive: true },
  'blespam -t google':  { severity: SEVERITY.HIGH,     category: 'attack',   target: 'ble',      resultHint: 'Google Fast Pair', destructive: true },
  'blespam -t samsung': { severity: SEVERITY.HIGH,     category: 'attack',   target: 'ble',      resultHint: 'Samsung spam', destructive: true },
  'blespam -t windows': { severity: SEVERITY.HIGH,     category: 'attack',   target: 'ble',      resultHint: 'Windows Swift Pair', destructive: true },
  'spoofat -t 0':       { severity: SEVERITY.MEDIUM,   category: 'attack',   target: 'ble',      resultHint: 'AirTag spoof' },
